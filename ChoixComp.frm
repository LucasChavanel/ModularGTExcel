...
Private Sub ModifQStream()
    ...
    For I = 1 To nbLignes
        'On ajoute à la liste visible les composants ajoutés
...
Private Sub Bouton_AjoutStream_Click()
    ...
    'Apres avoir rentré le nom du stream, on mets à jour la liste dans la Sheet cachée puis on met à jour la liste du formulaire
    Dim nblignes2 As Integer
    nblignes2 = Sheets("ListCompStream").Range("C1").End(xlDown).Row
    
    'Pas de sécurité comme pour QStream car forcement au minimum 1 Input Stream et 1 Gas
...
Private Sub BoutonNewComp_Click()
    ...
    'Lorsque tous les champs du composants sont complétés mais que ce n'est pas le dernier du cycle, on enregistre ces données dans le tableau et on recharge le formulaire
    
    'Securité sur les champs
...
Private Sub ComboBox_Comp_Change()
    ...
    'On rend les cases communes à tous les composants visibles
    ...
    'Rendre les box d'entrée de paramètres invisibles
    ...
    '////////////////////////////////////Ajout des paramètres pour les composants/////////////////////////////
    'On met à jour les Streams
    ModifStream
    ModifCycle
    ...
    If composant_id = 1 Then
        ...
        'On rend les choix de paramètres visible et on change le label
        ...
        'On met à jour la liste de QSTream
        ModifQStream
    End If
...
Private Sub Enregistrer_comp()
    ...
    'On enregistre les différentes valeurs dans les cases appropriées du tableau
    Dim nbLignes As Integer
    composant_id = ComboBox_Comp.ListIndex + 1
